...
define('ga-wdi-boston.ember-auth/services/ajax', ['exports', 'ember', 'ember-ajax/services/ajax', 'ga-wdi-boston.ember-auth/config/environment'], function (exports, _ember, _emberAjaxServicesAjax, _gaWdiBostonEmberAuthConfigEnvironment) {
...
if (!runningTests) {
  require("ga-wdi-boston.ember-auth/app")["default"].create({"name":"ga-wdi-boston.ember-auth","version":"0.0.0+"});
}
