...
define("ember-file-upload/components/file-dropzone/template", ["exports"], function (exports) {
  exports.default = Ember.HTMLBars.template({ "id": "xsNA4E4R", "block": "{\"statements\":[[\"yield\",\"default\",[[\"helper\",[\"hash\"],null,[[\"supported\",\"active\",\"valid\"],[[\"get\",[\"supported\"]],[\"get\",[\"active\"]],[\"get\",[\"valid\"]]]]],[\"get\",[\"queue\"]]]]],\"locals\":[],\"named\":[],\"yields\":[\"default\"],\"blocks\":[],\"hasPartials\":false}", "meta": { "moduleName": "ember-file-upload/components/file-dropzone/template.hbs" } });
});
...
define("ember-file-upload/components/file-upload/template", ["exports"], function (exports) {
  exports.default = Ember.HTMLBars.template({ "id": "utJ2hVuo", "block": "{\"statements\":[[\"open-element\",\"input\",[]],[\"dynamic-attr\",\"id\",[\"unknown\",[\"for\"]],null],[\"static-attr\",\"type\",\"file\"],[\"dynamic-attr\",\"accept\",[\"unknown\",[\"accept\"]],null],[\"dynamic-attr\",\"multiple\",[\"unknown\",[\"multiple\"]],null],[\"dynamic-attr\",\"onchange\",[\"helper\",[\"action\"],[[\"get\",[null]],\"change\"],[[\"value\"],[\"target.files\"]]],null],[\"static-attr\",\"style\",\"display: none;\"],[\"flush-element\"],[\"close-element\"],[\"text\",\"\\n\"],[\"yield\",\"default\"],[\"text\",\"\\n\"]],\"locals\":[],\"named\":[],\"yields\":[\"default\"],\"blocks\":[],\"hasPartials\":false}", "meta": { "moduleName": "ember-file-upload/components/file-upload/template.hbs" } });
});
...
define('ember-file-upload/queue', ['exports', 'ember', 'ember-file-upload/file', 'ember-file-upload/computed/sum-by'], function (exports, _ember, _emberFileUploadFile, _emberFileUploadComputedSumBy) {
  ...
  exports['default'] = _ember['default'].Object.extend({
    ...
    _addFiles: function _addFiles(fileList, source) {
      ...
      for (var i = 0, len = fileList.length || fileList.size; i < len; i++) {
        ...
        if (fileBlob instanceof Blob) {
          var file = _emberFileUploadFile['default'].fromBlob(fileBlob, source);
    ...
    /**
      ...
      @default 0
     */
    size: (0, _emberFileUploadComputedSumBy['default'])('files', 'size'),
    ...
    /**
      ...
      @default 0
     */
    loaded: (0, _emberFileUploadComputedSumBy['default'])('files', 'loaded'),
...
/*globals requirejs, require *///# sourceMappingURL=addons.map
